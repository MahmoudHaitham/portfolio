export const experienceData = [
  {
    ...
    company: "Arab Academy for Science, Technology and Maritime Transport (AASTMT)",
    location: "Alexandria, Egypt",
    period: "Aug 2025 - Present",
    type: "Part-Time",
    description: "Teaching Assistant at the Faculty of Engineering, Computer Engineering Department",
    responsibilities: [
    ...
    skills: ["Teaching", "Mentoring", "Computer Architecture", "Digital Design", "Programming"],
  },
  {
    id: 2,
    ...
    company: "Gammal Tech",
    location: "Alexandria, Egypt",
    period: "Feb 2023 - Mar 2023, Aug 2024 - Sep 2024",
    type: "Internship",
    description: "Full-stack development of examination platform and mobile applications",
    responsibilities: [
    ...
    skills: ["Full-Stack Development", "PostgreSQL", "Flutter", "UI/UX", "API Integration"],
  },
  {
    id: 3,
    title: "Technical Examiner Trainee",
    company: "Fours for Advanced Industries",
    location: "Alexandria, Egypt",
    period: "Aug 2024 - Sep 2024",
    type: "Training",
    description: "4-week technical training program focusing on system testing and evaluation",
    responsibilities: [
    ...
    skills: ["Network Testing", "Security Testing", "Vulnerability Assessment", "System Evaluation"],
  },
];
...
export const educationData = [
  ...
  {
    id: 2,
    degree: "Summer Training in Intelligent Systems, Robotics, and Machine Learning",
